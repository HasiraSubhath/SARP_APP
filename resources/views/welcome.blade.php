...
<body>
    ...
    <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
        <div class="container mx-auto px-6 py-8">
            <h3 class="text-gray-700 text-3xl font-medium">Image Holder</h3>
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-6">
                @for ($i = 0; $i < 8; $i++)
                    <div class="w-full bg-white rounded-lg shadow-md">
                        <img class="w-full h-48 object-cover object-center" src="https://via.placeholder.com/300" alt="Image">
                        <div class="p-4">
                            <h4 class="text-gray-900 font-medium text-lg">Sample Image</h4>
                            <p class="text-gray-600 mt-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed auctor, nisl ac tincidunt tincidunt, nunc elit aliquam nunc, nec tincidunt nunc elit id urna.</p>
                        </div>
                    </div>
                @endfor
            </div>
